...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-head-icon i { color: #d97706; font-size: 16px; }
...
<main>
    ...
    <div class="page-sub">Perbarui informasi kategori buku</div>
    ...
    <div class="card">
        ...
        <div class="card-head">
            ...
            <div>
                <div class="card-head-title">Form Edit Kategori</div>
                <div class="card-head-sub">ID: #{{ $category->id }}</div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    <label class="form-label" for="nama">
                        ...
                        <span class="form-hint">— akan dibuat slug otomatis</span>
                    </label>
