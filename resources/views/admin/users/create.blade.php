...
<main>
    ...
    <div class="page-title">Tambah Akun</div>
    <div class="page-sub">Buat akun pengguna baru untuk sistem</div>
        ...
        <div class="form-layout">
            ...
            <div class="card">
                <div class="card-head">
                    ...
                    <div>
                        <div class="card-head-title">Form Tambah Akun</div>
            ...
            <div class="card profile-card">
                ...
                <div class="card-body">
                    <div class="avatar-xl" id="previewAvatar">?</div>
                    <div>
                        <div class="profile-name" id="previewName" style="color:var(--muted); font-style:italic; font-weight:500">Nama belum diisi</div>
                        <div class="profile-email" id="previewEmail">—</div>
                    </div>
