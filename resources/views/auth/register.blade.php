...
<head>
    ...
    <title>Daftar — Smart Pustaka</title>
    ...
    <style>
        * { -webkit-font-smoothing: antialiased; box-sizing: border-box; }
        ...
        .fade-up-6 { animation-delay: 0.58s; }
        .fade-up-7 { animation-delay: 0.66s; }
...
<main class="flex-1 relative bg-white overflow-hidden flex items-center justify-center py-20 px-4">
    ...
    <div class="relative z-10 w-full flex flex-col items-center gap-8">
        ...
        <div class="login-card fade-up fade-up-2">
            ...
            <div class="mb-8">
                ...
                <h1 class="card-title mb-2">
                    Daftar ke <span class="accent">Smart Pustaka</span>
                </h1>
                <p style="font-size:14px;color:var(--text-secondary);line-height:1.6;">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="link-blue">Masuk sekarang</a>
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="fade-up fade-up-5">
                    ...
                    <div class="input-group pwd-wrap">
                        ...
                        <button type="button" class="pwd-toggle" onclick="togglePwd('password','eyeIcon1')">
                ...
                <div class="fade-up fade-up-6">
                    ...
                    <div class="input-group pwd-wrap">
                        ...
                        />
                        <i class="fas fa-lock input-icon"></i>
                        <button type="button" class="pwd-toggle" onclick="togglePwd('password_confirmation','eyeIcon2')">
                ...
                <!-- Submit -->
                <div class="fade-up fade-up-7" style="padding-top:8px;">
        ...
        <!-- Bottom note -->
        <p class="fade-up fade-up-7 text-center" style="font-size:12px;color:#94a3b8;animation-delay:0.75s;">
            © 2026 Smart Pustaka. Dengan mendaftar, kamu menyetujui
