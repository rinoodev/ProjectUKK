...
<head>
    ...
    <title>Lupa Password — Smart Pustaka</title>
        ...
        <div class="login-card fade-up fade-up-2">
            ...
            <div class="mb-8">
                ...
                <h1 class="card-title mb-2">
                    Lupa <span class="accent">Password?</span>
                </h1>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                ...
                <!-- Submit -->
                <div class="fade-up fade-up-4" style="padding-top:8px;">
            ...
            <p style="text-align:center;font-size:13px;color:var(--text-secondary);">
                Ingat password kamu?
                <a href="{{ route('login') }}" class="link-blue">Kembali ke Login</a>
            </p>
