        ...
        <div class="card">
            <div class="card-head">
                ...
                <div>
                    ...
                    <div class="card-head-sub">Isi semua informasi buku dengan benar</div>
                </div>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('petugas.books.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="text" name="kode_buku" value="{{ old('kode_buku') }}"
                                   placeholder="1234-XXX-XXX-XXX-XX" required>
                        </div>
                    </div>
                            ...
                            @forelse($categories as $category)
                                <div class="checkbox-item">
                                    <input type="checkbox" id="kategori_{{ $category->id }}"
                                           name="kategori_id[]"
                                           value="{{ $category->id }}"
                                           {{ in_array($category->id, old('kategori_id', [])) ? 'checked' : '' }}>
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            ...
                            <textarea name="deskripsi" placeholder="Tulis deskripsi singkat buku…">{{ old('deskripsi') }}</textarea>
                        </div>
                    </div>
